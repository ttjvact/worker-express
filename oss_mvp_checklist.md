...
- [x] GitHub Releases を使うか決めた
- [ ] Issues / PR / Discussions の運用を決めた
...
- [ ] `.env` や API キー、トークンが履歴に含まれていないことを確認した
...
- [ ] クローン直後にセットアップできることを確認した
- [ ] README の手順を手元で再現した
- [ ] サンプルコードが動くことを確認した
- [ ] 公開するバージョン番号とタグ名を確定した
- [ ] 公開範囲に秘密情報がないことを最終確認した
